...
<body class="bgcolor-custom" oncontextmenu="window.event.returnValue=false" onselectstart="return false">
<!--[if lte IE 8]>
	<script>
	    if(getUrlParam("returnUrl")==null) {
	    	location.href = "compat_login.html";
	    }
	    else {
	    	location.href = "compat_login.html?returnUrl=" + encodeURIComponent(getUrlParam("returnUrl"));
	    }
	</script>
<![endif]-->
    <div id="login-page" class="row">
        <div class="col s12 z-depth-6 card-panel" style="background: rgba(255,255,255,0.7)">
